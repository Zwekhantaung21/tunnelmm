...
<div id="dropdown" className="z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 block position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(318.4px, 70.4px, 0px);" data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="bottom">
